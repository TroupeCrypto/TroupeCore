...
echo ""
echo -e "${YELLOW}Branch with outdated/conflicting changes:${NC}"
echo "  11. copilot/remove-placeholder-data-dashboard (PR #31)"
echo ""
...
echo -e "${BLUE}Deleting outdated/conflicting branch...${NC}"
...
echo "2. Only 'main' and 'copilot/merge-all-branches' should remain"
echo "3. Merge PR #34 (copilot/merge-all-branches)"
echo "4. Delete 'copilot/merge-all-branches' branch after merge"
echo ""
